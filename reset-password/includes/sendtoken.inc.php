...
if (isset($_POST['resentsend'])) {
    ...
    */
    ...
    if (!verify_csrf_token()){
        ...
        $_SESSION['STATUS']['resentsend'] = 'A solicitação não pôde ser validada';
        header("Location: ../");
        exit();
    }
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)){
        ...
        if (mysqli_stmt_num_rows($stmt) == 0){
            ...
            $_SESSION['ERRORS']['emailerror'] = 'determinado e-mail não existe em nossos registros';
            header("Location: ../");
            exit();
        }
    }
    ...
    */
    ...
    $_SESSION['STATUS']['resentsend'] = 'E-mail de verificação enviado';
    header("Location: ../");
    exit();
}
else {
