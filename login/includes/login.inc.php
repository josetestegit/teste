...
if (!isset($_POST['loginsubmit'])){
    ...
    */
    ...
    if (!verify_csrf_token()){
        ...
        $_SESSION['STATUS']['loginstatus'] = 'A solicitação não pôde ser validada';
        header("Location: ../");
        exit();
    }
    ...
    if (empty($username) || empty($password)) {
        ...
        $_SESSION['STATUS']['loginstatus'] = 'os campos não podem ficar vazios';
        header("Location: ../");
        exit();
    } 
    else {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($pwdCheck == false) {
                    ...
                    $_SESSION['ERRORS']['wrongpassword'] = 'senha incorreta';
                    header("Location: ../");
                    exit();
                } 
                ...
                $_SESSION['ERRORS']['nouser'] = 'Usuário não existe';
                header("Location: ../");
                exit();
            }
        }
