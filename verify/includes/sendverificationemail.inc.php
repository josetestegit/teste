...
if (isset($_POST['verifysubmit'])) {
    ...
    */
    ...
    if (!verify_csrf_token()){
        ...
        $_SESSION['STATUS']['verify'] = 'A solicitação não pôde ser validada';
        header("Location: ../");
        exit();
    }
    ...
    */
    ...
    try {
        ...
        // for public use
        $_SESSION['STATUS']['verify'] = 'não foi possível enviar o e-mail, tente novamente mais tarde';
    ...
    $_SESSION['STATUS']['verify'] = 'E-mail de verificação enviado';
    header("Location: ../");
    exit();
}
else {
