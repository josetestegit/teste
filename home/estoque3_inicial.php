...
function setEvent(){
    ...
    function chama_atualiza(){
     ...
     window.location.href = ("estoque3_inicial.php");
...
<div class="tudo">
    ...
    <div class="centralizar">
     <label class="titulo">ESTOQUE 3 - SÃO PAULO</label><br>
        ...
        <form  class="form" method="post" action="estoque3.php">
...
<label style="font-weight: bold; font-family: arial; font-size: 12px; color: blue;"><?php echo number_format("$qtd_total_itens[0]",0,",",".").' ITENS'    ?></label> 
...
<label style="font-weight: bold;"><?php echo number_format("$qtd_total_itens[0]",0,",",".").' itens'    ?> </label><br>
