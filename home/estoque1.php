...
function setEvent(){
    ...
    function chama_atualiza(){
     ...
     window.location.href = ("estoque1.php");
...
<div class="tudo">
    ...
    <div class="centralizar">
     <label class="titulo">ESTOQUE 1 - CURITIBA - ÁGUA VERDE</label><br>
        ...
        <form  class="form" action="estoque1.php" method="post">
...
echo '<td class="td_est_max">'. $row["estoque_max"].' UN.'.' </td>';  
echo '<td class="td_situacao_produto">'. $row["situacao"].' </td>';  
echo '<td class="td_valor_medio">'.'R$ '. $row["preco_medio"].' </td>';
echo '<td class="td_valor_total_item">'.'R$ '.$valor_total_item.' </td>';
echo '</tr>';          
echo '</tbody>';
